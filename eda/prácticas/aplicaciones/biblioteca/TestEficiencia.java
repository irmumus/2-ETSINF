 ...
 * Tabla Hash Enlazada con FACTOR_CARGA = 0.75, los factores que determinan la
 * eficiencia del Map son los que hacen que el factor de carga real de la Tabla,  
 * o longitud media de sus cubetas, sea o no menor o igual que 0.75.
 * A saber:
 ...
 * resultados los factores de carga (reales), desviaciones tipicas, costes
 * promedio de localizacion de una clave e histogramas de ocupacion de 
 * 3 Tablas Hash Enlazadas de tallas maximas estimadas:
...
public class TestEficiencia {
    ...
    public static void main(String[] args) {
        ...
        if (args.length != 2) { 
            ...
            System.out.println("\n\nPruebas para Tablas de talla " 
                               + NUM_TERMINOS
                               + ", hashCode() con base " + baseHashCode 
                               + " y " + conRehashing + " Rehashing\n");
            ...
            try {
                ...
                for (int i = 0; i < MAX_TERMINOS.length; i++) {
                    ...
                    System.out.printf("\tFactor de carga real = %4.3f\n", tH.factorCarga());
