...
public class Test2Map {
    public static void main(String[] args) {
        ...
        // separadas por blancos. Una frase (String) ejemplo 
        //seria: "vale, aunque es un poco rollo lo hago 
        //para que se vea como funciona el Map!! Se me ha olvidado 
        //escribir palabras repetidas vaya!!"
        // Lectura de la frase (String) a partir de la que 
        //se construye el Map
        ...
        /**EJERCICIO 1*/
        //Me creo un contador para ver las distintas claves que hay
        int cont = 0;
        deClaves.inicio();
